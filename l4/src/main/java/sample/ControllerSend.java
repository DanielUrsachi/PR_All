...
public class ControllerSend {
    ...
    public void clickHTML() throws IOException {
        ...
        System.out.println(subject);
        htmlSend("udanny95@gmail.com","simpleHTML@gmail.com",  subject,  body, cod);
        sceneHandler1();//back
    ...
    public void sendFisier() throws IOException {
        ...
        subject= l1a.getText();
        body= l2a.getText();
        attSend("udanny95@gmail.com","simpleAttachment@gmail.com",  subject,  body, cod);
        sceneHandler1();//back
